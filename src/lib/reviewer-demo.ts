...
const reviewerSeedVersion = "mortgage-demo-v4";
...
const reviewerContacts: ImportContact[] = [
  {
    ...
    leadType: "application sent not started",
    area: "Austin",
    priceRange: "$520K",
    ...
    consent: "ok",
    ownerName: "Adam",
    rawNotes: "Had purchase consult. Adam sent the application link, but the borrower never started it.",
    normalizedSummary: "Borrower had a purchase consult and received the application link but never started.",
    pipelineMetadata: {
      current_status: "application sent not started",
      loan_intent: "purchase",
      estimated_loan_amount: 520000,
      referral_source: "Elena Park",
      missing_next_step: "start application",
  ...
  },
  {
    ...
    phone: "2815550206",
    source: "Old CRM",
    leadType: "pre-approval declined not ready",
    area: "Houston",
    priceRange: "$455K",
    ...
    consent: "ok",
    ownerName: "Adam",
    rawNotes: "Pre-qualification failed because credit score was below threshold. No later recovery follow-up.",
    normalizedSummary: "Borrower was not ready before but may be worth a fresh path review.",
    pipelineMetadata: {
      current_status: "pre-approval declined not ready",
      loan_intent: "purchase",
      estimated_loan_amount: 455000,
      referral_source: "Facebook lead",
      missing_next_step: "fresh path review",
  ...
  },
  {
    ...
    leadType: "contacted application not sent",
    area: "Sugar Land",
    priceRange: "$575K",
    timeline: "Active purchase",
    ...
    consent: "ok",
    ownerName: "Adam",
    rawNotes: "Warm referral from agent. Borrower asked about payment range, but Adam never sent the application link.",
    normalizedSummary: "Warm agent referral needs the application link and first-step help.",
    pipelineMetadata: {
      current_status: "contacted application not sent",
      loan_intent: "purchase",
  ...
  },
  {
    ...
    phone: "7135550212",
    source: "Old CRM",
    leadType: "loan process dead could not fund",
    area: "Pearland",
    priceRange: "$390K",
    timeline: "Paused purchase",
    ...
    consent: "ok",
    ownerName: "Adam",
    rawNotes: "Loan process died when the bank could not fund under the prior structure. No later recovery follow-up.",
    normalizedSummary: "Dead loan file could be resurfaced because lender options or timing may have changed.",
    pipelineMetadata: {
      current_status: "loan process dead could not fund",
      loan_intent: "purchase",
      estimated_loan_amount: 390000,
      referral_source: "Old CRM",
      missing_next_step: "restart conversation",
  ...
  },
  {
    ...
    phone: "2815550213",
    source: "Open house",
    leadType: "new inbound referral from Facebook",
    area: "Cypress",
    priceRange: "$440K",
    timeline: "30-60 days",
    ...
    pipelineMetadata: {
      current_status: "new inbound referral",
      loan_intent: "purchase",
  ...
  },
  {
    ...
    consent: "ok",
    ownerName: "Janine",
    rawNotes: "Pre-approval declined after credit review; borrower needed a 60-day plan and was never rechecked.",
    normalizedSummary: "Credit blocker may have changed and deserves a fresh review touch.",
    pipelineMetadata: {
      current_status: "pre-approval declined not ready",
      loan_intent: "purchase",
      estimated_loan_amount: 360000,
      referral_source: "Phone consult",
      missing_next_step: "fresh credit path review",
